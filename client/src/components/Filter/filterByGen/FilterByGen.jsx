...
const FilterByGen = () => {
  ...
  return (
    <div className={styles.FilterByGen}>
      <div className={currentGen === "firstGen"?`${styles.firstGen} ${styles.containerGens} ${styles.containerGens_active}`:`${styles.firstGen} ${styles.containerGens}`}>
      ...
      <div className={currentGen === "secondGen"?`${styles.secondGen} ${styles.containerGens} ${styles.containerGens_active}`:`${styles.secondGen} ${styles.containerGens}`}>
      ...
      <div className={currentGen === "thirdGen"?`${styles.thirdGen} ${styles.containerGens} ${styles.containerGens_active}`:`${styles.thirdGen} ${styles.containerGens}`}>
      ...
      <div className={currentGen === "fourthGen"?`${styles.fourthGen} ${styles.containerGens} ${styles.containerGens_active}`:`${styles.fourthGen} ${styles.containerGens}`}>
      ...
      <div className={currentGen === "fifthGen"?`${styles.fifthGen} ${styles.containerGens} ${styles.containerGens_active}`:`${styles.fifthGen} ${styles.containerGens}`}>
      ...
      <div className={currentGen === "sixthGen"?`${styles.sixthGen} ${styles.containerGens} ${styles.containerGens_active}`:`${styles.sixthGen} ${styles.containerGens}`}>
      ...
      <div className={currentGen === "seventhGen"?`${styles.seventhGen} ${styles.containerGens} ${styles.containerGens_active}`:`${styles.seventhGen} ${styles.containerGens}`}>
      ...
      <div className={currentGen === "eighthGen"?`${styles.eighthGen} ${styles.containerGens} ${styles.containerGens_active}`:`${styles.eighthGen} ${styles.containerGens}`}>
      ...
      <div className={currentGen === "ninthGen"?`${styles.ninthGen} ${styles.containerGens} ${styles.containerGens_active}`:`${styles.ninthGen} ${styles.containerGens}`}>
